            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="" action="{{ route('contact.store') }}" method="post">
                      @csrf
                      氏名<input type="text" name="your_name"><br>
                      件名<input type="text" name="title"><br>
                      メールアドレス<input type="text" name="email"><br>
                      ホームページ<input type="text" name="url"><br>
                      ...
                      お問い合わせ内容 <textarea name="contact"></textarea><br>

                      <input type="checkbox" name="caution" value="1">注意事項に同意する <br>

                      <input class="btn btn-info" type="submit" name="" value="登録する">
                    </form>
                </div>
            </div>
        </div>
